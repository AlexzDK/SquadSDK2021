...
// WidgetBlueprintGeneratedClass BMP-2_GunnerReticle.BMP-2_GunnerReticle_C
// 0x00A0 (FullSize[0x0300] - InheritedSize[0x0260])
class UBMP_2_GunnerReticle_C : public USQVehicleViewWidget
{
public:
	...
	class ABP_BMP2_Turret_C*                           BMP2_TurretRef;                                            // 0x02F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BMP-2_GunnerReticle.BMP-2_GunnerReticle_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BMP_2_GunnerReticle(int EntryPoint);
};
