...
// BlueprintGeneratedClass MI17_MEA_Crash.MI17_MEA_Crash_C
// 0x00C8 (FullSize[0x03F0] - InheritedSize[0x0328])
class AMI17_MEA_Crash_C : public ABP_GenericHelicopterWreck_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass MI17_MEA_Crash.MI17_MEA_Crash_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_MI17_MEA_Crash(int EntryPoint);
};
