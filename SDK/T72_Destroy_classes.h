...
// BlueprintGeneratedClass T72_Destroy.T72_Destroy_C
// 0x0038 (FullSize[0x0358] - InheritedSize[0x0320])
class AT72_Destroy_C : public ABP_GenericDestroyedVehicleWreck_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass T72_Destroy.T72_Destroy_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_T72_Destroy(int EntryPoint);
};
