...
struct ABP_MTLB_PKT_C_ResumeAnimations_Params
{
...
struct ABP_MTLB_PKT_C_StopAnimations_Params
{
...
struct ABP_MTLB_PKT_C_PlayAnimations_Params
{
	class UAnimMontage*                                TripodAnim;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAnimMontage*                                WeaponAnim;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAnimMontage*                                SoldierAnim;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct ABP_MTLB_PKT_C_BndEvt__SQTemperature_K2Node_ComponentBoundEvent_486_TemperatureIncrementDelegate__DelegateSignature_Params
{
...
struct ABP_MTLB_PKT_C_BlueprintOnFire_Params
{
...
struct ABP_MTLB_PKT_C_BlueprintOnReload_Params
{
};

// Function BP_MTLB_PKT.BP_MTLB_PKT_C.SoldierLeavesVehicle
struct ABP_MTLB_PKT_C_SoldierLeavesVehicle_Params
{
	class ASQSoldier*                                  Soldier;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_MTLB_PKT.BP_MTLB_PKT_C.SoldierEntersVehicle
struct ABP_MTLB_PKT_C_SoldierEntersVehicle_Params
{
	class ASQSoldier*                                  Soldier;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_MTLB_PKT.BP_MTLB_PKT_C.ExecuteUbergraph_BP_MTLB_PKT
struct ABP_MTLB_PKT_C_ExecuteUbergraph_BP_MTLB_PKT_Params
{
