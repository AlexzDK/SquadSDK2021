...
struct FChaosPhysicsCollisionInfo
{
	...
	unsigned char                                      UnknownData_HL2I[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4HJ5[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_O6AR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
