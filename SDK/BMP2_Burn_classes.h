...
// BlueprintGeneratedClass BMP2_Burn.BMP2_Burn_C
// 0x0038 (FullSize[0x0358] - InheritedSize[0x0320])
class ABMP2_Burn_C : public ABP_GenericDestroyedVehicleWreck_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BMP2_Burn.BMP2_Burn_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BMP2_Burn(int EntryPoint);
};
