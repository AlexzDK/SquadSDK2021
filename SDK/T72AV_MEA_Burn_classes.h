...
// BlueprintGeneratedClass T72AV_MEA_Burn.T72AV_MEA_Burn_C
// 0x0038 (FullSize[0x0358] - InheritedSize[0x0320])
class AT72AV_MEA_Burn_C : public ABP_GenericDestroyedVehicleWreck_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass T72AV_MEA_Burn.T72AV_MEA_Burn_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_T72AV_MEA_Burn(int EntryPoint);
};
