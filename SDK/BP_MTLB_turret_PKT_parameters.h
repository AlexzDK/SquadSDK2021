...
struct ABP_MTLB_turret_PKT_C_GetPitchMovementComponent_Params
{
...
struct ABP_MTLB_turret_PKT_C_GetYawMovementComponent_Params
{
	class USQMovementComponentBase*                    ReturnValue;                                               // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_MTLB_turret_PKT.BP_MTLB_turret_PKT_C.GetWeaponAttachComponent
struct ABP_MTLB_turret_PKT_C_GetWeaponAttachComponent_Params
{
...
struct ABP_MTLB_turret_PKT_C_GetMasterPoseComponent_Params
{
