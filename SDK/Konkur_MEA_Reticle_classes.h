...
// WidgetBlueprintGeneratedClass Konkur_MEA_Reticle.Konkur_MEA_Reticle_C
// 0x0040 (FullSize[0x02A0] - InheritedSize[0x0260])
class UKonkur_MEA_Reticle_C : public USQVehicleViewWidget
{
public:
	...
	class ABP_Spandrel_MEA_Turret_Static_C*            SpandrelTurretRef;                                         // 0x0288(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Konkur_MEA_Reticle.Konkur_MEA_Reticle_C");
		return ptr;
	}
	...
	void UpdateAmmo();
	void ExecuteUbergraph_Konkur_MEA_Reticle(int EntryPoint);
};
