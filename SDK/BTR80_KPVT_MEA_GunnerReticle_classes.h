...
// WidgetBlueprintGeneratedClass BTR80_KPVT_MEA_GunnerReticle.BTR80_KPVT_MEA_GunnerReticle_C
// 0x0090 (FullSize[0x02F0] - InheritedSize[0x0260])
class UBTR80_KPVT_MEA_GunnerReticle_C : public USQVehicleViewWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BTR80_KPVT_MEA_GunnerReticle.BTR80_KPVT_MEA_GunnerReticle_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTR80_KPVT_MEA_GunnerReticle(int EntryPoint);
};
