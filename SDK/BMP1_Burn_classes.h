...
class ABMP1_Burn_C : public ABP_GenericDestroyedVehicleWreck_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BMP1_Burn.BMP1_Burn_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BMP1_Burn(int EntryPoint);
};
