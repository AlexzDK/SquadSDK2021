...
{
	unsigned char                                      UnknownData_F01O[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AI0O[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FUserPlatform                               Platform;                                                  // 0x0020(0x0010) (HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_BMVR[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FUniqueNetIdRepl                            PlatformUniqueId;                                          // 0x0060(0x0028) (HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_W6VV[0x30];                                    // 0x0088(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FString                                     PlatformSessionId;                                         // 0x00B8(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_O93T[0x30];                                    // 0x00C8(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0E65[0x37];                                    // 0x00F9(0x0037) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7BDV[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPartyPrivacySettings                       PrivacySettings;                                           // 0x0020(0x0003) (NoDestructor, Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_PBZJ[0x35];                                    // 0x0023(0x0035) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G1JQ[0x18];                                    // 0x0068(0x0018) MISSED OFFSET (PADDING)
...
struct FSocialChatChannelConfig
{
	...
	unsigned char                                      UnknownData_6ZSV[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class USocialChatChannel*>                  ListenChannels;                                            // 0x0018(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_A5R4[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
