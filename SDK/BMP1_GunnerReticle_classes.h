...
class UBMP1_GunnerReticle_C : public USQVehicleViewWidget
{
public:
	...
	class ABP_BMP1_Turret_INS_C*                       BMP1_TurretRef;                                            // 0x02E8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABP_T62_Commander_Periscope_C*               CommanderTurret;                                           // 0x02F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BMP1_GunnerReticle.BMP1_GunnerReticle_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BMP1_GunnerReticle(int EntryPoint);
};
