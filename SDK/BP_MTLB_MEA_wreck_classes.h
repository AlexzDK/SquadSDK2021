...
// BlueprintGeneratedClass BP_MTLB_MEA_wreck.BP_MTLB_MEA_wreck_C
// 0x0020 (FullSize[0x0340] - InheritedSize[0x0320])
class ABP_MTLB_MEA_wreck_C : public ABP_GenericDestroyedVehicleWreck_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MTLB_MEA_wreck.BP_MTLB_MEA_wreck_C");
		return ptr;
	}
