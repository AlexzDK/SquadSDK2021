...
// WidgetBlueprintGeneratedClass Tpku2b_MEA_Periscope_reticle.Tpku2b_MEA_Periscope_reticle_C
// 0x0038 (FullSize[0x0298] - InheritedSize[0x0260])
class UTpku2b_MEA_Periscope_reticle_C : public USQVehicleViewWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Tpku2b_MEA_Periscope_reticle.Tpku2b_MEA_Periscope_reticle_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Tpku2b_MEA_Periscope_reticle(int EntryPoint);
};
