...
struct FStructSerializerArrayTestStruct
{
	...
	unsigned char                                      UnknownData_CDLS[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStructSerializerNumericTestStruct
{
	...
	unsigned char                                      UnknownData_R7D3[0x1];                                     // 0x0001(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VGAZ[0x1];                                     // 0x0011(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FBU7[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStructSerializerBuiltinTestStruct
{
	...
	unsigned char                                      UnknownData_24FI[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H2Q4[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YME6[0xC];                                     // 0x0084(0x000C) MISSED OFFSET (PADDING)
...
struct FStructSerializerTestStruct
{
	...
	unsigned char                                      UnknownData_WHRN[0x5];                                     // 0x0033(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FStructSerializerObjectTestStruct           Objects;                                                   // 0x0038(0x00A0) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_K4W3[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
