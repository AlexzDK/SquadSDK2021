...
// BlueprintGeneratedClass T72AV_MEA_Destroy.T72AV_MEA_Destroy_C
// 0x0038 (FullSize[0x0358] - InheritedSize[0x0320])
class AT72AV_MEA_Destroy_C : public ABP_GenericDestroyedVehicleWreck_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass T72AV_MEA_Destroy.T72AV_MEA_Destroy_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_T72AV_MEA_Destroy(int EntryPoint);
};
