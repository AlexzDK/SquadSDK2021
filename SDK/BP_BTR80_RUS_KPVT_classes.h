...
public:
	...
	unsigned char                                      UnknownData_BYE8[0x4];                                     // 0x09D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_BTR80_RUS_KPVT.BP_BTR80_RUS_KPVT_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_BTR80_RUS_KPVT(int EntryPoint);
};
