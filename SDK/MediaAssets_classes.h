...
{
public:
	unsigned char                                      UnknownData_W0W6[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WA7Y[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_P2Y9[0x1];                                     // 0x00D3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PKLC[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J84S[0xB0];                                    // 0x00F0(0x00B0) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QL84[0x3];                                     // 0x0641(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_9IT0[0x3];                                     // 0x0645(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8K3N[0x4];                                     // 0x065C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5L3G[0x1E8];                                   // 0x0668(0x01E8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_O1WZ[0x2];                                     // 0x00C2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S2CK[0x3];                                     // 0x00C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4XD8[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R4MM[0x2C];                                    // 0x00F4(0x002C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QDNP[0x8];                                     // 0x0130(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7WMZ[0x17];                                    // 0x0049(0x0017) MISSED OFFSET (PADDING)
