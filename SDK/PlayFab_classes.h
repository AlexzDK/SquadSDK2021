...
public:
	...
	unsigned char                                      UnknownData_QY1L[0x888];                                   // 0x0038(0x0888) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DOUX[0x50];                                    // 0x08D8(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OPCS[0xB8];                                    // 0x0038(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XGLZ[0x50];                                    // 0x0108(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_DI19[0x388];                                   // 0x0038(0x0388) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L4S8[0x50];                                    // 0x03D8(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_3RCK[0x98];                                    // 0x0038(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HTJL[0x50];                                    // 0x00E8(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QL3U[0x58];                                    // 0x0038(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O2L4[0x50];                                    // 0x00A8(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3PWO[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4PIH[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_GY2J[0x1D8];                                   // 0x0038(0x01D8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1MPB[0x50];                                    // 0x0228(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_PDSL[0x68];                                    // 0x0038(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EPNC[0x50];                                    // 0x00B8(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_H2OQ[0xB8];                                    // 0x0038(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x00F0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x00F8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x0100(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_DZLG[0x50];                                    // 0x0108(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_210E[0x68];                                    // 0x0038(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x00A0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x00A8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x00B0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_TK1C[0x50];                                    // 0x00B8(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_KMN7[0xA08];                                   // 0x0038(0x0A08) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PM2A[0x50];                                    // 0x0A58(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_ZS8L[0x68];                                    // 0x0038(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UPlayFabAuthenticationContext*               CallAuthenticationContext;                                 // 0x00A0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                          RequestJsonObj;                                            // 0x00A8(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                          ResponseJsonObj;                                           // 0x00B0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_PC4Q[0x50];                                    // 0x00B8(0x0050) MISSED OFFSET (PADDING)
...
public:
	struct FScriptMulticastDelegate                    OnPlayFabResponse;                                         // 0x0028(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_TKF5[0x728];                                   // 0x0038(0x0728) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4D07[0x50];                                    // 0x0778(0x0050) MISSED OFFSET (PADDING)
