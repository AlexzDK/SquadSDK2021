...
// WidgetBlueprintGeneratedClass W_MI8_EngineStats.W_MI8_EngineStats_C
// 0x0080 (FullSize[0x02B0] - InheritedSize[0x0230])
class UW_MI8_EngineStats_C : public UUserWidget
{
public:
	...
	class ASQHelicopter2*                              VehicleRef;                                                // 0x02A8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass W_MI8_EngineStats.W_MI8_EngineStats_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_W_MI8_EngineStats(int EntryPoint);
};
