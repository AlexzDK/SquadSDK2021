...
// BlueprintGeneratedClass BP_T62_Kord_Cupola_Turret.BP_T62_Kord_Cupola_Turret_C
// 0x0068 (FullSize[0x0498] - InheritedSize[0x0430])
class ABP_T62_Kord_Cupola_Turret_C : public ASQVehicleTurretClosedTop
{
public:
	...
	float                                              Timeline_0_lerp_1A44F1604BC0D5C28545BDBE4EF41438;          // 0x0488(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Timeline_0__Direction_1A44F1604BC0D5C28545BDBE4EF41438;    // 0x048C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_WR1J[0x3];                                     // 0x048D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_T62_Kord_Cupola_Turret.BP_T62_Kord_Cupola_Turret_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_T62_Kord_Cupola_Turret(int EntryPoint);
};
