...
class ABP_MTLB_turret_PKT_C : public ASQVehicleTurretClosedTop
{
public:
	...
	class UStaticMeshComponent*                        MTLB_PKT_turret_static_mesh;                               // 0x0458(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	float                                              Timeline_0_lerp_71A13BAC4CEAD5137B1A539732D6BACA;          // 0x0488(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Timeline_0__Direction_71A13BAC4CEAD5137B1A539732D6BACA;    // 0x048C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_XGXT[0x3];                                     // 0x048D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MTLB_turret_PKT.BP_MTLB_turret_PKT_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MTLB_turret_PKT(int EntryPoint);
};
