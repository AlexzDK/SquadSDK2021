...
// BlueprintGeneratedClass BMP1_MEA_Burn.BMP1_MEA_Burn_C
// 0x0038 (FullSize[0x0358] - InheritedSize[0x0320])
class ABMP1_MEA_Burn_C : public ABP_GenericDestroyedVehicleWreck_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BMP1_MEA_Burn.BMP1_MEA_Burn_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BMP1_MEA_Burn(int EntryPoint);
};
