...
// WidgetBlueprintGeneratedClass BP_MapWidgetMapMarker_Path.BP_MapWidgetMapMarker_Path_C
// 0x0050 (FullSize[0x0320] - InheritedSize[0x02D0])
class UBP_MapWidgetMapMarker_Path_C : public USQMapWidgetMapMarkerSelectable
{
public:
	...
	class USizeBox*                                    DistanceBox;                                               // 0x02E0(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UBorder*                                     Fill;                                                      // 0x02E8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UScaleBox*                                   IconBox;                                                   // 0x02F8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_6GO0[0x7];                                     // 0x0311(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BP_MapWidgetMapMarker_Path.BP_MapWidgetMapMarker_Path_C");
		return ptr;
	}
	...
	void Destruct();
	void OnRightClicked();
	void ExecuteUbergraph_BP_MapWidgetMapMarker_Path(int EntryPoint);
};
