...
class AT62_Destroy_C : public ABP_GenericDestroyedVehicleWreck_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass T62_Destroy.T62_Destroy_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_T62_Destroy(int EntryPoint);
};
