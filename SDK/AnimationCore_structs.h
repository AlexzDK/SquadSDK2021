...
struct FConstraintDescriptor
{
	...
	unsigned char                                      UnknownData_OPQ2[0xF];                                     // 0x0001(0x000F) MISSED OFFSET (PADDING)
...
struct FConstraintData
{
	...
	unsigned char                                      UnknownData_CPDL[0xB];                                     // 0x0015(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FConstraintOffset
{
	...
	unsigned char                                      UnknownData_6F9N[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CNA6[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_ASDI[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_NB4Z[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FFilterOptionPerAxis                        AxesFilterOption;                                          // 0x0008(0x0003) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_NCR0[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (PADDING)
...
struct FAxis
{
	...
	unsigned char                                      UnknownData_T3ZH[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FAimConstraintDescription : public FConstraintDescriptionEx
{
	...
	unsigned char                                      UnknownData_1762[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTransformConstraint
{
	...
	unsigned char                                      UnknownData_QXWF[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QH5R[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FTransformConstraintDescription : public FConstraintDescriptionEx
{
	...
	unsigned char                                      UnknownData_WBZL[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
