...
class AFOB_US_Damage_C : public ASQLastingEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass FOB_US_Damage.FOB_US_Damage_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_FOB_US_Damage(int EntryPoint);
};
