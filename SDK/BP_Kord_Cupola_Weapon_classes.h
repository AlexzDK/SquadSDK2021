...
// BlueprintGeneratedClass BP_Kord_Cupola_Weapon.BP_Kord_Cupola_Weapon_C
// 0x0070 (FullSize[0x0A28] - InheritedSize[0x09B8])
class ABP_Kord_Cupola_Weapon_C : public ASQVehicleWeapon
{
public:
	...
	unsigned char                                      UnknownData_42VK[0x4];                                     // 0x09D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Kord_Cupola_Weapon.BP_Kord_Cupola_Weapon_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Kord_Cupola_Weapon(int EntryPoint);
};
