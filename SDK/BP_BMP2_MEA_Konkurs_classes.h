...
// BlueprintGeneratedClass BP_BMP2_MEA_Konkurs.BP_BMP2_MEA_Konkurs_C
// 0x00D8 (FullSize[0x0AF8] - InheritedSize[0x0A20])
class ABP_BMP2_MEA_Konkurs_C : public ASQVehicleWeaponTOW
{
public:
	...
	unsigned char                                      UnknownData_E7PU[0x4];                                     // 0x0A3C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_83R9[0x3];                                     // 0x0AC1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_81JA[0x4];                                     // 0x0AD4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_BMP2_MEA_Konkurs.BP_BMP2_MEA_Konkurs_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_BMP2_MEA_Konkurs(int EntryPoint);
