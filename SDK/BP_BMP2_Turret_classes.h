...
// BlueprintGeneratedClass BP_BMP2_Turret.BP_BMP2_Turret_C
// 0x0078 (FullSize[0x04A8] - InheritedSize[0x0430])
class ABP_BMP2_Turret_C : public ASQVehicleTurretClosedTop
{
public:
	...
	float                                              Timeline_0_lerp_5A15BCD3456BCD3D59962ABCDBCFE3CE;          // 0x0490(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Timeline_0__Direction_5A15BCD3456BCD3D59962ABCDBCFE3CE;    // 0x0494(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_9UJN[0x3];                                     // 0x0495(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_BMP2_Turret.BP_BMP2_Turret_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_BMP2_Turret(int EntryPoint);
};
