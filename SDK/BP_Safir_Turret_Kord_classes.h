...
// BlueprintGeneratedClass BP_Safir_Turret_Kord.BP_Safir_Turret_Kord_C
// 0x0015 (FullSize[0x0470] - InheritedSize[0x045B])
class ABP_Safir_Turret_Kord_C : public ABP_Technical_Turret_C
{
public:
	unsigned char                                      UnknownData_OVCF[0x5];                                     // 0x045B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Safir_Turret_Kord.BP_Safir_Turret_Kord_C");
		return ptr;
	}
