...
public:
	...
	unsigned char                                      UnknownData_Q1U4[0xA4];                                    // 0x003C(0x00A4) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VLH7[0x300];                                   // 0x0028(0x0300) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UEditableMeshAdapter*>                Adapters;                                                  // 0x0328(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_STF5[0x8];                                     // 0x0338(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PYSI[0x148];                                   // 0x0344(0x0148) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_03U8[0x1E4];                                   // 0x0494(0x01E4) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JDHO[0x9C];                                    // 0x003C(0x009C) MISSED OFFSET (PADDING)
