...
// WidgetBlueprintGeneratedClass BMP-2_MEA_CommanderReticle.BMP-2_MEA_CommanderReticle_C
// 0x00A8 (FullSize[0x0308] - InheritedSize[0x0260])
class UBMP_2_MEA_CommanderReticle_C : public USQVehicleViewWidget
{
public:
	...
	class ABP_BMP2_MEA_Commander_Periscope_C*          BMP2_MEA_Cmdr_TurretRef;                                   // 0x02F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BMP-2_MEA_CommanderReticle.BMP-2_MEA_CommanderReticle_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BMP_2_MEA_CommanderReticle(int EntryPoint);
};
