...
class ABP_UB32_C : public ASQVehicleWeapon
{
public:
	...
	unsigned char                                      UnknownData_EDLB[0x4];                                     // 0x09D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_UB32.BP_UB32_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_UB32(int EntryPoint);
};
