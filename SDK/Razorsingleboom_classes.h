...
class ARazorsingleboom_C : public ASQLastingEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Razorsingleboom.Razorsingleboom_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Razorsingleboom(int EntryPoint);
};
