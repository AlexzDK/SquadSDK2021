...
class ABP_BTR80_RUS_Periscope_C : public ASQVehicleTurretClosedTop
{
public:
	...
	class USQVelocityRotatingMovementComponent*        PitchMovement;                                             // 0x0440(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class USQVelocityRotatingMovementComponent*        YawMovement;                                               // 0x0448(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UCameraComponent*                            FirstPersonCamera;                                         // 0x0450(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	class USkeletalMeshComponent*                      Turret_SkeletalMesh;                                       // 0x0468(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	float                                              Timeline_0_lerp_1400AB1E4BCEAC979126B7BDCD4C6A68;          // 0x0480(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Timeline_0__Direction_1400AB1E4BCEAC979126B7BDCD4C6A68;    // 0x0484(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_PDLF[0x3];                                     // 0x0485(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_BTR80_RUS_Periscope.BP_BTR80_RUS_Periscope_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_BTR80_RUS_Periscope(int EntryPoint);
};
