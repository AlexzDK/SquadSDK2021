...
// BlueprintGeneratedClass T72AV_MEA_Ammocook.T72AV_MEA_Ammocook_C
// 0x0040 (FullSize[0x0360] - InheritedSize[0x0320])
class AT72AV_MEA_Ammocook_C : public ABP_GenericDestroyedVehicleWreck_C
{
public:
	...
	class UParticleSystemComponent*                    Exploshiom;                                                // 0x0338(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass T72AV_MEA_Ammocook.T72AV_MEA_Ammocook_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_T72AV_MEA_Ammocook(int EntryPoint);
};
