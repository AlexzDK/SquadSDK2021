...
struct FRestrictedGameplayTagTableRow : public FGameplayTagTableRow
{
	...
	unsigned char                                      UnknownData_AU1C[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2QY7[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CYLU[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K2T9[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FGameplayTagQuery
{
	...
	unsigned char                                      UnknownData_XU97[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
