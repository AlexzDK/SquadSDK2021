...
class ARazorstackhalf_C : public ASQLastingEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Razorstackhalf.Razorstackhalf_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Razorstackhalf(int EntryPoint);
};
