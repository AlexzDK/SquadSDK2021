...
class USPG9_HEAT_Reticle_C : public USQVehicleViewWidget
{
public:
	...
	unsigned char                                      UnknownData_0F0R[0x4];                                     // 0x029C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SPG9_HEAT_Reticle.SPG9_HEAT_Reticle_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_SPG9_HEAT_Reticle(int EntryPoint);
};
