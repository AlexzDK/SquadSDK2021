...
struct FARSkeletonDefinition
{
	...
	unsigned char                                      UnknownData_AJV7[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FARPose3D
{
	...
	unsigned char                                      UnknownData_CC7B[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FARTraceResult
{
	...
	unsigned char                                      UnknownData_8AH2[0xB];                                     // 0x0005(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A15R[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (PADDING)
...
struct FARSessionStatus
{
	...
	unsigned char                                      UnknownData_24HB[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
