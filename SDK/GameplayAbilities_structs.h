...
struct FGameplayTagReponsePair
{
	...
	unsigned char                                      UnknownData_4OF6[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MFAZ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MF6L[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2GJW[0x10];                                    // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LG83[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J00V[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayTagBlueprintPropertyMapping
{
	...
	unsigned char                                      UnknownData_KI08[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FCKU[0xA8];                                    // 0x0000(0x00A8) MISSED OFFSET (PADDING)
...
struct FGameplayEffectCustomExecutionOutput
{
	...
	unsigned char                                      UnknownData_94CU[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FActiveGameplayEffectHandle
{
	...
	unsigned char                                      UnknownData_Z0WG[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FGameplayModifierEvaluatedData
{
	...
	unsigned char                                      UnknownData_L98T[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ADGF[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureDefinition
{
	...
	unsigned char                                      UnknownData_DC9F[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (PADDING)
...
struct FScalableFloat
{
	...
	unsigned char                                      UnknownData_Y4QJ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GSQS[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
struct FAttributeBasedFloat
{
	...
	unsigned char                                      UnknownData_VOBR[0x6];                                     // 0x009A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectModifierMagnitude
{
	...
	unsigned char                                      UnknownData_P9CE[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectExecutionScopedModifierInfo
{
	...
	unsigned char                                      UnknownData_XSJQ[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DF2Y[0x7];                                     // 0x01C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_YV20[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S2ZQ[0xF];                                     // 0x0011(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_GHMC[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_P17X[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HYYL[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J64T[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_78JA[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RP8F[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FGameplayModifierInfo
{
	...
	unsigned char                                      UnknownData_3P4J[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3M79[0x7];                                     // 0x01D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_2J89[0x70];                                    // 0x0000(0x0070) MISSED OFFSET (PADDING)
...
struct FGameplayCueTranslationManager
{
	...
	unsigned char                                      UnknownData_R8DJ[0x18];                                    // 0x0068(0x0018) MISSED OFFSET (PADDING)
...
struct FGameplayCueTranslatorNode
{
	...
	unsigned char                                      UnknownData_T7UG[0x54];                                    // 0x0024(0x0054) MISSED OFFSET (PADDING)
...
struct FGameplayCueTranslationLink
{
	...
	unsigned char                                      UnknownData_T9XP[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FGameplayCueNotifyData
{
	...
	unsigned char                                      UnknownData_8CKE[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FGameplayCueObjectLibrary
{
	...
	unsigned char                                      UnknownData_RXED[0x20];                                    // 0x0010(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BA0Z[0x4];                                     // 0x0048(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_A480[0x1B0];                                   // 0x0000(0x01B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GV9T[0x8];                                     // 0x01B8(0x0008) MISSED OFFSET (PADDING)
...
struct FPredictionKey
{
	...
	unsigned char                                      UnknownData_Y8SZ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MUFB[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8FBE[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AMKY[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_JXWS[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GTMO[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YSTG[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAbilityEndedData
{
	...
	unsigned char                                      UnknownData_YVC2[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HO94[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_00ZO[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_HJ2R[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGameplayAbilityTargetingLocationInfo       SourceLocation;                                            // 0x0010(0x0070) (Edit, BlueprintVisible, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
struct FGameplayAbilityTargetData_SingleTargetHit : public FGameplayAbilityTargetData
{
	...
	unsigned char                                      UnknownData_GRFI[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (PADDING)
...
struct FGameplayAbilityBindInfo
{
	...
	unsigned char                                      UnknownData_6W81[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAbilityTriggerData
{
	...
	unsigned char                                      UnknownData_XUMZ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WWC0[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttributeMetaData : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_DWOU[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XUZ2[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FGameplayAbilityActivationInfo
{
	...
	unsigned char                                      UnknownData_KYJ2[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayAbilitySpec : public FFastArraySerializerItem
{
	...
	unsigned char                                      UnknownData_MXRP[0x6];                                     // 0x002A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4UQZ[0x50];                                    // 0x0078(0x0050) MISSED OFFSET (PADDING)
...
struct FGameplayAbilityRepAnimMontage
{
	...
	unsigned char                                      UnknownData_5RLR[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPredictionKey                              PredictionKey;                                             // 0x0018(0x0018) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FGameplayAbilityLocalAnimMontage
{
	...
	unsigned char                                      UnknownData_T9QI[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_OMPR[0x30];                                    // 0x0108(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FActiveGameplayEffect>               GameplayEffects_Internal;                                  // 0x0138(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_JZQG[0x310];                                   // 0x0148(0x0310) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UGameplayEffect*>                     ApplicationImmunityQueryEffects;                           // 0x0458(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_HU81[0x18];                                    // 0x0468(0x0018) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureSpecContainer
{
	...
	unsigned char                                      UnknownData_7EXB[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FTagContainerAggregator
{
	...
	unsigned char                                      UnknownData_8H9K[0x28];                                    // 0x0060(0x0028) MISSED OFFSET (PADDING)
...
struct FGameplayEffectSpec
{
	...
	unsigned char                                      UnknownData_FOXR[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IRPE[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UGLS[0x3];                                     // 0x01C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FGameplayAbilitySpecDef>             GrantedAbilitySpecs;                                       // 0x01C8(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_3Z76[0xA0];                                    // 0x01D8(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WG4I[0x4];                                     // 0x0294(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AJDM[0xC];                                     // 0x000C(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_75HZ[0x9B];                                    // 0x02D5(0x009B) MISSED OFFSET (PADDING)
...
struct FGameplayAbilitySpecDef
{
	...
	unsigned char                                      UnknownData_7NFM[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R9QS[0x50];                                    // 0x0038(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7E7H[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureSpec
{
	...
	unsigned char                                      UnknownData_PH0R[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
struct FActiveGameplayCueContainer : public FFastArraySerializer
{
	...
	unsigned char                                      UnknownData_IINM[0x8];                                     // 0x0118(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FActiveGameplayCue : public FFastArraySerializerItem
{
	...
	unsigned char                                      UnknownData_U5SV[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPredictionKey                              PredictionKey;                                             // 0x0018(0x0018) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_9232[0x7];                                     // 0x00E9(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_I4A3[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JCZA[0x8];                                     // 0x0058(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HSWH[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPredictionKey                              PredictionKey;                                             // 0x0010(0x0018) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FGameplayAbilities_FServerAbilityRPCBatch
{
	...
	unsigned char                                      UnknownData_TQDM[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GC6K[0x5];                                     // 0x004B(0x0005) MISSED OFFSET (PADDING)
...
struct FGameplayEffectModifiedAttribute
{
	...
	unsigned char                                      UnknownData_RTUG[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_N7YG[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_44CJ[0x10];                                    // 0x0128(0x0010) MISSED OFFSET (PADDING)
...
struct FGameplayEventData
{
	...
	unsigned char                                      UnknownData_589R[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectRemovalInfo
{
	...
	unsigned char                                      UnknownData_Y0P6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_4CJO[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
