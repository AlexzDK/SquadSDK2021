...
struct ABP_MTLB_NSV_C_ResumeAnimations_Params
{
...
struct ABP_MTLB_NSV_C_StopAnimations_Params
{
...
struct ABP_MTLB_NSV_C_PlayAnimations_Params
{
	class UAnimMontage*                                TripodAnim;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAnimMontage*                                WeaponAnim;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAnimMontage*                                SoldierAnim;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct ABP_MTLB_NSV_C_BndEvt__SQTemperature_K2Node_ComponentBoundEvent_486_TemperatureIncrementDelegate__DelegateSignature_Params
{
...
struct ABP_MTLB_NSV_C_BlueprintOnFire_Params
{
...
struct ABP_MTLB_NSV_C_BlueprintOnReload_Params
{
};

// Function BP_MTLB_NSV.BP_MTLB_NSV_C.SoldierLeavesVehicle
struct ABP_MTLB_NSV_C_SoldierLeavesVehicle_Params
{
	class ASQSoldier*                                  Soldier;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_MTLB_NSV.BP_MTLB_NSV_C.SoldierEntersVehicle
struct ABP_MTLB_NSV_C_SoldierEntersVehicle_Params
{
	class ASQSoldier*                                  Soldier;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_MTLB_NSV.BP_MTLB_NSV_C.ExecuteUbergraph_BP_MTLB_NSV
struct ABP_MTLB_NSV_C_ExecuteUbergraph_BP_MTLB_NSV_Params
{
