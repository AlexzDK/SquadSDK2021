...
struct ABP_T72B3_Turret_C_InpActEvt_DesignateTarget_K2Node_InputActionEvent_1_Params
{
	struct FKey                                        Key;                                                       // (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
};

// Function BP_T72B3_Turret.BP_T72B3_Turret_C.ServerSetStabilizationHeading
struct ABP_T72B3_Turret_C_ServerSetStabilizationHeading_Params
{
};

// Function BP_T72B3_Turret.BP_T72B3_Turret_C.ExecuteUbergraph_BP_T72B3_Turret
struct ABP_T72B3_Turret_C_ExecuteUbergraph_BP_T72B3_Turret_Params
{
