...
struct FLightmassWorldInfoSettings
{
	...
	unsigned char                                      UnknownData_LNRM[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMaterialProxySettings
{
	...
	unsigned char                                      UnknownData_2CPZ[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshMergingSettings
{
	...
	unsigned char                                      UnknownData_SHUV[0x1];                                     // 0x008B(0x0001) MISSED OFFSET (PADDING)
...
struct FHierarchicalSimplification
{
	...
	unsigned char                                      UnknownData_EYJP[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWorldPSCPool
{
	...
	unsigned char                                      UnknownData_Q7I9[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FPSCPool
{
	...
	unsigned char                                      UnknownData_TNT6[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FPSCPoolElem
{
	...
	unsigned char                                      UnknownData_VFAO[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FLevelViewportInfo
{
	...
	unsigned char                                      UnknownData_82C0[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OB4B[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4KM6[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T2C3[0x33];                                    // 0x000D(0x0033) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5KTY[0xC];                                     // 0x0044(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_R0PS[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QS2Y[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RCAZ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStreamingLevelsToConsider
{
	...
	unsigned char                                      UnknownData_FQH3[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
struct FVirtualTextureSpacePoolConfig
{
	...
	unsigned char                                      UnknownData_6WK9[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FTimeStretchCurve
{
	...
	unsigned char                                      UnknownData_RELB[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FTimeStretchCurveInstance
{
	...
	unsigned char                                      UnknownData_1TL3[0x2F];                                    // 0x0001(0x002F) MISSED OFFSET (PADDING)
...
struct FTTTrackBase
{
	unsigned char                                      UnknownData_SHQF[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P1CG[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FTimeline
{
	...
	unsigned char                                      UnknownData_O9BJ[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E79V[0x10];                                    // 0x0080(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTimelineLinearColorTrack
{
	...
	unsigned char                                      UnknownData_PFO6[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
...
struct FTimelineFloatTrack
{
	...
	unsigned char                                      UnknownData_W89T[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
...
struct FTimelineVectorTrack
{
	...
	unsigned char                                      UnknownData_ORKF[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
...
struct FStreamingRenderAssetPrimitiveInfo
{
	...
	unsigned char                                      UnknownData_100R[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FTextureLODGroup
{
	...
	unsigned char                                      UnknownData_H684[0xB];                                     // 0x0001(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C0U8[0x4];                                     // 0x0018(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2Q5J[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PTDL[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KIHD[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RO5J[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6HK9[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5D3G[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LJFX[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStringCurveKey
{
	...
	unsigned char                                      UnknownData_OHQS[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMaterialParameterInfo
{
	...
	unsigned char                                      UnknownData_KT5Y[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMaterialLayersParameter
{
	...
	unsigned char                                      UnknownData_UI7O[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K45B[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FStaticTerrainLayerWeightParameter
{
	...
	unsigned char                                      UnknownData_7JJK[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LBNM[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FStaticComponentMaskParameter
{
	...
	unsigned char                                      UnknownData_0DSX[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticSwitchParameter
{
	...
	unsigned char                                      UnknownData_35Z5[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       ExpressionGUID;                                            // 0x0014(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
	unsigned char                                      UnknownData_RZ9M[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ISOQ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_EWJU[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WD7H[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMeshComponentInstanceData : public FPrimitiveComponentInstanceData
{
	...
	unsigned char                                      UnknownData_JSCK[0x8];                                     // 0x0128(0x0008) MISSED OFFSET (PADDING)
...
struct FStaticMeshVertexColorLODData
{
	...
	unsigned char                                      UnknownData_2TOY[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FStaticMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownData_CG3J[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SFZX[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ELM0[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
struct FMeshBuildSettings
{
	...
	unsigned char                                      UnknownData_AUIE[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TZC9[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshReductionSettings
{
	...
	unsigned char                                      UnknownData_13G4[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (PADDING)
...
struct FStaticMeshSourceModel
{
	...
	unsigned char                                      UnknownData_JUR3[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshSectionInfo
{
	...
	unsigned char                                      UnknownData_7CX2[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FAssetEditorOrbitCameraPosition
{
	...
	unsigned char                                      UnknownData_YQCL[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshUVChannelInfo
{
	...
	unsigned char                                      UnknownData_VQJS[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMaterial
{
	...
	unsigned char                                      UnknownData_QP8H[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FMaterialRemapIndex
{
	...
	unsigned char                                      UnknownData_NVNE[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSplinePoint
{
	...
	unsigned char                                      UnknownData_VJWN[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (PADDING)
...
struct FSplineInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_KH4Y[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_UTB1[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FSoundWaveSpectralDataPerSound
{
	...
	unsigned char                                      UnknownData_EIEH[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundWaveSpectralTimeData
{
	...
	unsigned char                                      UnknownData_2PIY[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FRealCurve : public FIndexedCurve
{
	...
	unsigned char                                      UnknownData_VSG8[0x2];                                     // 0x006A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundSubmixSendInfo
{
	...
	unsigned char                                      UnknownData_C0QR[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7YFW[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundSourceBusSendInfo
{
	...
	unsigned char                                      UnknownData_7NNX[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	float                                              MinSendDistance;                                           // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                              MaxSendDistance;                                           // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_CQR8[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRuntimeFloatCurve                          CustomSendLevelCurve;                                      // 0x0028(0x0088) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
struct FModulatorContinuousParams
{
	...
	unsigned char                                      UnknownData_7OWR[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QVEC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundClassAdjuster
{
	...
	unsigned char                                      UnknownData_PDP7[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundGroup
{
	...
	unsigned char                                      UnknownData_PSIG[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BBSX[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSourceEffectChainEntry
{
	...
	unsigned char                                      UnknownData_U7UC[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EQ4A[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSoundConcurrencySettings
{
	...
	unsigned char                                      UnknownData_Y6UW[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RY2H[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JF1U[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_YY6E[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSoundClassProperties
{
	...
	unsigned char                                      UnknownData_8LGP[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MB1N[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3XQ3[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_C0PW[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4KVS[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1B5W[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundAttenuationSettings : public FBaseAttenuationSettings
{
	...
	unsigned char                                      UnknownData_W0JR[0x2];                                     // 0x00B6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_TGDP[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YF21[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MEFO[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FPrecomputedSkyLightInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_WWMV[0xA4];                                    // 0x00BC(0x00A4) MISSED OFFSET (PADDING)
...
struct FSkinWeightProfileInfo
{
	...
	unsigned char                                      UnknownData_27GR[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBoneNode
{
	...
	unsigned char                                      UnknownData_288P[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T2B8[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KYJV[0x48];                                    // 0x0000(0x0048) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshSamplingRegion
{
	...
	unsigned char                                      UnknownData_XMHA[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshSamplingRegionBoneFilter
{
	...
	unsigned char                                      UnknownData_HE4F[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownData_KT08[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L1S1[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4EN2[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6OZY[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshLODGroupSettings
{
	...
	unsigned char                                      UnknownData_KISA[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_14KZ[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6KQP[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FBoneFilter
{
	...
	unsigned char                                      UnknownData_7DCH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_FMPD[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HBWF[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FBoneMirrorInfo
{
	...
	unsigned char                                      UnknownData_545B[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FBoneMirrorExport
{
	...
	unsigned char                                      UnknownData_TPCA[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshClothBuildParams
{
	...
	unsigned char                                      UnknownData_GRUO[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7KGG[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshLODInfo
{
	...
	unsigned char                                      UnknownData_EUMJ[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NHS7[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LFJ8[0x7];                                     // 0x00A1(0x0007) MISSED OFFSET (PADDING)
...
{
	struct FName                                       BoneName;                                                  // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_PA1H[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FClothingAssetData_Legacy
{
	...
	unsigned char                                      UnknownData_0LV3[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FClothPhysicsProperties_Legacy              PhysicsProperties;                                         // 0x001C(0x0050) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_7MS8[0xC];                                     // 0x006C(0x000C) MISSED OFFSET (PADDING)
...
struct FSkeletalMaterial
{
	...
	unsigned char                                      UnknownData_2WT4[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FSimpleCurve : public FRealCurve
{
	...
	unsigned char                                      UnknownData_R0TR[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEngineShowFlagsSetting
{
	...
	unsigned char                                      UnknownData_XNL6[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FColorGradingSettings
{
	...
	unsigned char                                      UnknownData_XJ8N[0x8];                                     // 0x0148(0x0008) MISSED OFFSET (PADDING)
...
struct FConvolutionBloomSettings
{
	...
	unsigned char                                      UnknownData_645Q[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FLensBloomSettings
{
	...
	unsigned char                                      UnknownData_BK8U[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RR9C[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (PADDING)
...
struct FLensImperfectionSettings
{
	...
	unsigned char                                      UnknownData_CLXN[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FLensSettings
{
	...
	unsigned char                                      UnknownData_OH1E[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
struct FCameraExposureSettings
{
	...
	unsigned char                                      UnknownData_YGBO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3SM4[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FRootMotionMovementParams
{
	...
	unsigned char                                      UnknownData_31Z4[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G8DR[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionFinishVelocitySettings
{
	...
	unsigned char                                      UnknownData_472S[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_FMOY[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PXIP[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6CZC[0xD];                                     // 0x0033(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JC7X[0x4];                                     // 0x0094(0x0004) Fix Super Size
...
struct FRootMotionSource_ConstantForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_7CG9[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_RadialForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_CX1C[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5FO3[0x6];                                     // 0x00BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V56K[0x3];                                     // 0x00D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_MoveToForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_65BY[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_MoveToDynamicForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_KGOI[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_JumpForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_D3SN[0x3];                                     // 0x00AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KMVG[0x10];                                    // 0x00C0(0x0010) MISSED OFFSET (PADDING)
...
struct FNode
{
	...
	unsigned char                                      UnknownData_TU0Z[0xF];                                     // 0x0051(0x000F) MISSED OFFSET (PADDING)
...
struct FRigTransformConstraint
{
	...
	unsigned char                                      UnknownData_N1SO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_9ASO[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DZ4Q[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LR0X[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BP7B[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKeyBind
{
	...
	unsigned char                                      UnknownData_GC5L[0x6];                                     // 0x002A(0x0006) MISSED OFFSET (PADDING)
...
struct FInputAxisProperties
{
	...
	unsigned char                                      UnknownData_NRK5[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FInputActionKeyMapping
{
	...
	unsigned char                                      UnknownData_LAFV[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInputAxisKeyMapping
{
	...
	unsigned char                                      UnknownData_L0QP[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FKey                                        Key;                                                       // 0x0010(0x0018) (Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FPostProcessSettings
{
	...
	unsigned char                                      UnknownData_GCE3[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GKS4[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2D3W[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TPJH[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5CNK[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_97GO[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GQZ8[0x3];                                     // 0x03F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BEF5[0x3];                                     // 0x0421(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TC6T[0x3];                                     // 0x043D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VJ3Z[0x4];                                     // 0x044C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UQNJ[0x3];                                     // 0x04D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QWCR[0x2];                                     // 0x04EE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T9RG[0x2];                                     // 0x04FE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7Y04[0x4];                                     // 0x0514(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FWeightedBlendables                         WeightedBlendables;                                        // 0x0518(0x0010) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_PVMF[0x8];                                     // 0x0528(0x0008) MISSED OFFSET (PADDING)
...
struct FMinimalViewInfo
{
	...
	unsigned char                                      UnknownData_TZEG[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QVWO[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QO61[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_URMC[0x48];                                    // 0x0578(0x0048) MISSED OFFSET (PADDING)
...
struct FCameraCacheEntry
{
	...
	unsigned char                                      UnknownData_PZ0X[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTViewTarget
{
	...
	unsigned char                                      UnknownData_H0Z4[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T0BJ[0x8];                                     // 0x05D8(0x0008) MISSED OFFSET (PADDING)
...
struct FPhysicalSurfaceName
{
	...
	unsigned char                                      UnknownData_E8TS[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_P0P9[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FLinearConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_WDI8[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
struct FConeConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_BBTX[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
struct FTwistConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_P6NL[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintDrive
{
	...
	unsigned char                                      UnknownData_M1KE[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FLinearDriveConstraint
{
	...
	unsigned char                                      UnknownData_6O8C[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (PADDING)
...
struct FAngularDriveConstraint
{
	...
	unsigned char                                      UnknownData_00JV[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintProfileProperties
{
	...
	unsigned char                                      UnknownData_4ZD9[0x3];                                     // 0x0101(0x0003) MISSED OFFSET (PADDING)
...
struct FPhysicalAnimationData
{
	...
	unsigned char                                      UnknownData_QIJ5[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTireFrictionScalePair
{
	...
	unsigned char                                      UnknownData_RO74[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8QB0[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6O8D[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Q51R[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FParticleSysParam
{
	...
	unsigned char                                      UnknownData_MBYC[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QD06[0x40];                                    // 0x0040(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_W84J[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FGPUSpriteLocalVectorFieldInfo
{
	...
	unsigned char                                      UnknownData_YBRU[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0010(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_J95N[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
...
struct FDistributionLookupTable
{
	...
	unsigned char                                      UnknownData_CH4W[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8H7R[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FGPUSpriteEmitterInfo
{
	...
	unsigned char                                      UnknownData_W0CJ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C7LI[0x2];                                     // 0x018A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bEnableCollision : 1;                                      // 0x018C(0x0001) BIT_FIELD  (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_F4V1[0x3];                                     // 0x018D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AHH2[0x3];                                     // 0x0191(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bRemoveHMDRoll : 1;                                        // 0x0194(0x0001) BIT_FIELD  (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_7661[0x3];                                     // 0x0195(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M5LS[0x10];                                    // 0x02B0(0x0010) MISSED OFFSET (PADDING)
...
struct FGPUSpriteResourceData
{
	...
	unsigned char                                      UnknownData_Z259[0x2];                                     // 0x0146(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K18F[0x3];                                     // 0x0151(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NYVH[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimationRecordingSettings
{
	...
	unsigned char                                      UnknownData_MVGR[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YYI7[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FBlendSampleData
{
	...
	unsigned char                                      UnknownData_5DHF[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XUKF[0x20];                                    // 0x0020(0x0020) MISSED OFFSET (PADDING)
...
struct FBlendFilter
{
	unsigned char                                      UnknownData_UGOG[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FAnimTickRecord
{
	...
	unsigned char                                      UnknownData_F5PY[0x40];                                    // 0x0008(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TAWP[0x70];                                    // 0x0000(0x0070) MISSED OFFSET (PADDING)
...
struct FAnimationGroupReference
{
	...
	unsigned char                                      UnknownData_X1ZZ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FKAggregateGeom
{
	...
	unsigned char                                      UnknownData_NELS[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FKShapeElem
{
	unsigned char                                      UnknownData_U99L[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ABDD[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0H6B[0x17];                                    // 0x0019(0x0017) MISSED OFFSET (PADDING)
...
struct FKTaperedCapsuleElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_5QF9[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FKConvexElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_AXK0[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0060(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_CM30[0x10];                                    // 0x0090(0x0010) MISSED OFFSET (PADDING)
...
struct FKBoxElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_DJNV[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FName                                       Name;                                                      // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_MR0T[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SG6F[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FPoseLinkBase
{
	...
	unsigned char                                      UnknownData_YQK8[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TIUY[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Z6L7[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FAlphaBlend
{
	...
	unsigned char                                      UnknownData_RINR[0x18];                                    // 0x000C(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TZJF[0xB];                                     // 0x0025(0x000B) MISSED OFFSET (PADDING)
...
struct FInputAlphaBoolBlend
{
	...
	unsigned char                                      UnknownData_56QG[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_XXW7[0x54];                                    // 0x0000(0x0054) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0GD3[0xA8];                                    // 0x0058(0x00A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8YXV[0x7];                                     // 0x0101(0x0007) MISSED OFFSET (PADDING)
...
struct FWalkableSlopeOverride
{
	...
	unsigned char                                      UnknownData_4OE4[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I89V[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_E39D[0x6];                                     // 0x0000(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NS5J[0x1];                                     // 0x0007(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HE89[0x1];                                     // 0x0009(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G09L : 1;                                      // 0x000C(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_8P2Y : 2;                                      // 0x000E(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_Q8TY[0xD];                                     // 0x000F(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3S3K[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BBEC[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6TA2[0x10];                                    // 0x0098(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_60DP[0x40];                                    // 0x00D0(0x0040) MISSED OFFSET (PADDING)
...
struct FResponseChannel
{
	...
	unsigned char                                      UnknownData_CQ5I[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FDebugTextInfo
{
	...
	unsigned char                                      UnknownData_MT9J[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XKIO[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FQG7[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FPlatformInterfaceData
{
	...
	unsigned char                                      UnknownData_6W3B[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DT8H[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlatformInterfaceDelegateResult
{
	...
	unsigned char                                      UnknownData_TYZZ[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_3PBS[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FFormatArgumentData
{
	...
	unsigned char                                      UnknownData_QDFT[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8RD2[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FDebugFloatHistory
{
	...
	unsigned char                                      UnknownData_03TV[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpControlPoint
{
	...
	unsigned char                                      UnknownData_UUAA[0xF];                                     // 0x000D(0x000F) MISSED OFFSET (PADDING)
...
struct FFontParameterValue
{
	...
	unsigned char                                      UnknownData_R9T1[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FLightmassMaterialInterfaceSettings
{
	...
	unsigned char                                      UnknownData_5Y40[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WPMK[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZGKL[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FChannelDefinition
{
	...
	unsigned char                                      UnknownData_AKHV[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FBroadphaseSettings
{
	...
	unsigned char                                      UnknownData_812S[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSubtitleCue
{
	...
	unsigned char                                      UnknownData_BYS3[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FCachedKeyToActionInfo
{
	...
	unsigned char                                      UnknownData_1BV7[0x68];                                    // 0x0008(0x0068) MISSED OFFSET (PADDING)
...
struct FLightmassPrimitiveSettings
{
	...
	unsigned char                                      UnknownData_50Y0[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_8765[0xA8];                                    // 0x0000(0x00A8) MISSED OFFSET (PADDING)
...
struct FDebugDisplayProperty
{
	...
	unsigned char                                      UnknownData_W1AZ[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FClassRedirect
{
	...
	unsigned char                                      UnknownData_BZ5P[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
struct FStatColorMapping
{
	...
	unsigned char                                      UnknownData_URJH[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5ANY[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3PQ0[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInteriorSettings
{
	...
	unsigned char                                      UnknownData_IP8H[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FReverbSettings
{
	...
	unsigned char                                      UnknownData_4WFW[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPoseSnapshot
{
	...
	unsigned char                                      UnknownData_DXQL[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FSingleAnimationPlayData
{
	...
	unsigned char                                      UnknownData_JLNY[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YLE8[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSkelMeshComponentLODInfo
{
	...
	unsigned char                                      UnknownData_6CBO[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OVL2[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FForceFeedbackParameters
{
	...
	unsigned char                                      UnknownData_RM4B[0x1];                                     // 0x000B(0x0001) MISSED OFFSET (PADDING)
...
struct FUpdateLevelStreamingLevelStatus
{
	...
	unsigned char                                      UnknownData_ETMD[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JWKP[0x17];                                    // 0x0001(0x0017) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FUpdateLevelVisibilityLevelInfo
{
	...
	unsigned char                                      UnknownData_3I8W[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FViewTargetTransitionParams
{
	...
	unsigned char                                      UnknownData_GQQ5[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z5WE[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FActiveForceFeedbackEffect
{
	...
	unsigned char                                      UnknownData_BGUN[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FHitResult
{
	...
	unsigned char                                      UnknownData_6W77[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRepAttachment
{
	...
	unsigned char                                      UnknownData_FBPJ[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_66YC[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FEmitterDynamicParameter
{
	...
	unsigned char                                      UnknownData_BFB5[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A41N[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D7T3[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOrbitOptions
{
	...
	unsigned char                                      UnknownData_7X22[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FParticleEvent_GenerateInfo
{
	...
	unsigned char                                      UnknownData_LFSF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KLYD[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBeamModifierOptions
{
	...
	unsigned char                                      UnknownData_TWDY[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FParticleRandomSeedInfo
{
	...
	unsigned char                                      UnknownData_EE3Y[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNodeItem
{
	...
	unsigned char                                      UnknownData_N6AN[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0010(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
struct FNavAgentSelector
{
	...
	unsigned char                                      UnknownData_H2V9[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
...
struct FNavigationLinkBase
{
	...
	unsigned char                                      UnknownData_UIXW[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_56HG[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TJ9N[0x6];                                     // 0x0022(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J7QJ[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FMeshInstancingSettings
{
	...
	unsigned char                                      UnknownData_FHF7[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMemberReference
{
	...
	unsigned char                                      UnknownData_OLMG[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (PADDING)
...
struct FScalarParameterAtlasInstanceData
{
	...
	unsigned char                                      UnknownData_L7CX[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFunctionExpressionInput
{
	...
	unsigned char                                      UnknownData_A0V9[0xC];                                     // 0x0024(0x000C) MISSED OFFSET (PADDING)
...
struct FCustomInput
{
	...
	unsigned char                                      UnknownData_NXPN[0x8];                                     // 0x0014(0x0008) MISSED OFFSET (PADDING)
...
struct FMaterialSpriteElement
{
	...
	unsigned char                                      UnknownData_5CUU[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_812B[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FParameterGroupData
{
	...
	unsigned char                                      UnknownData_BU57[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FClientReceiveData
{
	...
	unsigned char                                      UnknownData_AI63[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBatchedLine
{
	...
	unsigned char                                      UnknownData_IQFQ[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (PADDING)
...
struct FBatchedPoint
{
	...
	unsigned char                                      UnknownData_YLYZ[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CKBS[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5W1U[0xC];                                     // 0x00F4(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_28SG[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FDynamicTextureInstance : public FStreamableTextureInstance
{
	...
	unsigned char                                      UnknownData_PG26[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSimplificationDetails
{
	...
	unsigned char                                      UnknownData_63ZZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NXOF[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P265[0x2];                                     // 0x0102(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZRLZ[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLayerActorStats
{
	...
	unsigned char                                      UnknownData_P8GW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y4Q6[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FDrawToRenderTargetContext
{
	...
	unsigned char                                      UnknownData_277Y[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TJ19[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TGWC[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FVisibilityTrackKey
{
	...
	unsigned char                                      UnknownData_M03N[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FToggleTrackKey
{
	...
	unsigned char                                      UnknownData_SKIE[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FSoundTrackKey
{
	...
	unsigned char                                      UnknownData_7C7T[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBoolTrackKey
{
	...
	unsigned char                                      UnknownData_YPIT[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimControlTrackKey
{
	...
	unsigned char                                      UnknownData_4DES[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FBPU[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FSupportedSubTrackInfo
{
	...
	unsigned char                                      UnknownData_IEIR[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FSubTrackGroup
{
	...
	unsigned char                                      UnknownData_QJSQ[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FCurveEdEntry
{
	...
	unsigned char                                      UnknownData_QTDM[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FIntegralCurve : public FIndexedCurve
{
	...
	unsigned char                                      UnknownData_TYK3[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (PADDING)
...
struct FInstancedStaticMeshComponentInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_8WCD[0x20];                                    // 0x0100(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YYHR[0xC];                                     // 0x0124(0x000C) MISSED OFFSET (PADDING)
...
struct FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_Y8C1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintInputTouchDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_CDNT[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6S5B[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NL2Q[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8K8D[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_06IA[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlueprintInputActionDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_G2TP[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlueprintCookedComponentInstancingData
{
	...
	unsigned char                                      UnknownData_JTZ4[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W7VA[0x38];                                    // 0x0018(0x0038) MISSED OFFSET (PADDING)
...
struct FImportanceTexture
{
	...
	unsigned char                                      UnknownData_14LN[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X9Y9[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FHLODProxyMesh
{
	...
	unsigned char                                      UnknownData_BIPM[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FActiveHapticFeedbackEffect
{
	...
	unsigned char                                      UnknownData_T8G3[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FPredictProjectilePathParams
{
	...
	unsigned char                                      UnknownData_PPQI[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PHWV[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C1TW[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MB5Y[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (PADDING)
...
struct FPredictProjectilePathResult
{
	...
	unsigned char                                      UnknownData_IANW[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
struct FForceFeedbackChannelDetails
{
	...
	unsigned char                                      UnknownData_870D[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFontImportOptionsData
{
	...
	unsigned char                                      UnknownData_S8FI[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C31A[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JWQL[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QU0C[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VR62[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BVS6[0x3];                                     // 0x00A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZXQI[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
...
struct FFontCharacter
{
	...
	unsigned char                                      UnknownData_PKVX[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRigidBodyState
{
	...
	unsigned char                                      UnknownData_SD7E[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5ETR[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FRigidBodyContactInfo
{
	...
	unsigned char                                      UnknownData_3AHR[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLightmassLightSettings
{
	...
	unsigned char                                      UnknownData_BJRL[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FLightmassDebugOptions
{
	...
	unsigned char                                      UnknownData_RB2O[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CMYD[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSwarmDebugOptions
{
	...
	unsigned char                                      UnknownData_GME9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FPrimitiveMaterialRef
{
	...
	unsigned char                                      UnknownData_PFPB[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FOverlapResult
{
	...
	unsigned char                                      UnknownData_VWM7[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bBlockingHit : 1;                                          // 0x0014(0x0001) BIT_FIELD  (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_88QN[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6XYG[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_URJ0[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_306G[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FComponentReference
{
	...
	unsigned char                                      UnknownData_XXZR[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
struct FDepthFieldGlowInfo
{
	...
	unsigned char                                      UnknownData_857R[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFontRenderInfo
{
	...
	unsigned char                                      UnknownData_FWGE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_A9EM[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FExposureSettings
{
	...
	unsigned char                                      UnknownData_HVNU[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WGBE[0xD0];                                    // 0x0000(0x00D0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F8VY[0x10];                                    // 0x01B8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class ULevel*>                              LoadedLevelsForPendingMapChange;                           // 0x01C8(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_W79L[0x18];                                    // 0x01D8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q3OD[0x50];                                    // 0x0230(0x0050) MISSED OFFSET (PADDING)
...
struct FNamedNetDriver
{
	...
	unsigned char                                      UnknownData_525O[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FLevelStreamingStatus
{
	...
	unsigned char                                      UnknownData_NGPY[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFullyLoadedPackagesInfo
{
	...
	unsigned char                                      UnknownData_ZC5D[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FScreenMessageString
{
	...
	unsigned char                                      UnknownData_MHSI[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V9E3[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelNameAndTime
{
	...
	unsigned char                                      UnknownData_TLNA[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ACWU[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4IVY[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JF9E[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMulticastRecordOptions
{
	...
	unsigned char                                      UnknownData_VZRU[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WTF6[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DAWT[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MYH0[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H3TJ[0x7];                                     // 0x0085(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FConstraintProfileProperties                ProfileInstance;                                           // 0x008C(0x0104) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_VOR6[0x28];                                    // 0x0190(0x0028) MISSED OFFSET (PADDING)
...
struct FAutoCompleteNode
{
	...
	unsigned char                                      UnknownData_YUME[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        AutoCompleteListIndices;                                   // 0x0008(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_PJDX[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FCollisionResponseTemplate
{
	...
	unsigned char                                      UnknownData_K9RC[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_23PL[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YYUE[0x27];                                    // 0x0039(0x0027) MISSED OFFSET (PADDING)
...
struct FCustomChannelSetup
{
	...
	unsigned char                                      UnknownData_93F9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       Name;                                                      // 0x0004(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_O7VN[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (PADDING)
...
struct FChildActorComponentInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_ZD2C[0x10];                                    // 0x00C0(0x0010) MISSED OFFSET (PADDING)
...
struct FFindFloorResult
{
	...
	unsigned char                                      UnknownData_0T27[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_7HZD[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YDG2[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FFOscillator
{
	...
	unsigned char                                      UnknownData_UJDP[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FCachedAnimStateArray
{
	...
	unsigned char                                      UnknownData_10FX[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FCachedAnimStateData
{
	...
	unsigned char                                      UnknownData_5YD4[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimAssetPlayerData
{
	struct FName                                       StateMachineName;                                          // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       StateName;                                                 // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_BDBC[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FCachedAnimRelevancyData
{
	struct FName                                       StateMachineName;                                          // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       StateName;                                                 // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_11WY[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimTransitionData
{
	...
	unsigned char                                      UnknownData_PWH3[0xC];                                     // 0x0018(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WWW1[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T8TP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EDU7[0x2];                                     // 0x0000(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DF3A[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7BW8[0x190];                                   // 0x0000(0x0190) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7QOT[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7X0P[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventGraphFastCallPair
{
	...
	unsigned char                                      UnknownData_OHTN[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FBlueprintComponentChangedPropertyInfo
{
	...
	unsigned char                                      UnknownData_ZYUV[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCompilerNativizationOptions
{
	...
	unsigned char                                      UnknownData_GKTK[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_QCTO[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEdGraphTerminalType
{
	...
	unsigned char                                      UnknownData_7KP7[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (PADDING)
...
struct FEdGraphPinType
{
	...
	unsigned char                                      UnknownData_35TE[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (PADDING)
...
struct FBPVariableDescription
{
	...
	unsigned char                                      UnknownData_GJ6R[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEditedDocumentInfo
{
	...
	unsigned char                                      UnknownData_ZAPT[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInterpolationParameter
{
	...
	unsigned char                                      UnknownData_BHA4[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FBlendParameter
{
	...
	unsigned char                                      UnknownData_VU9G[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MQX3[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
struct FEditorImportExportTestDefinition
{
	...
	unsigned char                                      UnknownData_ZQQT[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEditorMapPerformanceTestDefinition
{
	...
	unsigned char                                      UnknownData_6I9B[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FAudioQualitySettings
{
	...
	unsigned char                                      UnknownData_DQHX[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FAudioComponentParam
{
	...
	unsigned char                                      UnknownData_UD2H[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7HPN[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_RK42[0x1E0];                                   // 0x00A8(0x01E0) MISSED OFFSET (PADDING)
...
struct FPrimaryAssetRules
{
	...
	unsigned char                                      UnknownData_YPY3[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IB03[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FPrimaryAssetTypeInfo
{
	...
	unsigned char                                      UnknownData_UTXL[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CFCU[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_B6DS[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FAnimNotifyTrack
{
	...
	unsigned char                                      UnknownData_X4IA[0x20];                                    // 0x0018(0x0020) MISSED OFFSET (PADDING)
...
struct FMarkerSyncData
{
	...
	unsigned char                                      UnknownData_BH1L[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimationTransitionRule
{
	...
	unsigned char                                      UnknownData_BQCG[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBakedAnimationStateMachine
{
	...
	unsigned char                                      UnknownData_NC33[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimationTransitionBetweenStates : public FAnimationStateBase
{
	...
	unsigned char                                      UnknownData_AST2[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z7AR[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FBakedAnimationState
{
	...
	unsigned char                                      UnknownData_CEB6[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8YJF[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
struct FBakedStateExitTransition
{
	...
	unsigned char                                      UnknownData_ZHAE[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_SingleNode : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_IAA7[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QJO6[0x6D0];                                   // 0x0000(0x06D0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7E3N[0x150];                                   // 0x06D0(0x0150) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_39TC[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_2O5X[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FExposedValueHandler
{
	...
	unsigned char                                      UnknownData_WRVI[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FExposedValueCopyRecord
{
	...
	unsigned char                                      UnknownData_9TEC[0x1];                                     // 0x0017(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_TransitionResult : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_I7SR[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LNHM[0x38];                                    // 0x0010(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_044Q[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IV0A[0x6];                                     // 0x0052(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_SubInput : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_L4HR[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OT6E[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5VAS[0x8];                                     // 0x00C0(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OES7[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FAnimNode_StateMachine : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_9UNV[0x96];                                    // 0x001A(0x0096) MISSED OFFSET (PADDING)
...
struct FAnimNode_AssetPlayerBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_6B9V[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q5Q1[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FInputScaleBiasClamp
{
	...
	unsigned char                                      UnknownData_60CV[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OXVH[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_SequencePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_KL1E[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_SaveCachedPose : public FAnimNode_Base
{
	...
	struct FName                                       CachePoseName;                                             // 0x0020(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_BGEX[0x90];                                    // 0x0028(0x0090) MISSED OFFSET (PADDING)
...
struct FAnimNode_SubInstance : public FAnimNode_CustomProperty
{
	...
	unsigned char                                      UnknownData_MRFE[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimNode_ApplyMeshSpaceAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_SYKY[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7SPB[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J1QD[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCompositeSection : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData_T0ZG[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBranchingPointMarker
{
	...
	unsigned char                                      UnknownData_XX94[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimMontageInstance
{
	...
	unsigned char                                      UnknownData_SS7D[0x20];                                    // 0x0008(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               bPlaying;                                                  // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_W79P[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TXRC[0xB8];                                    // 0x0030(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SA38[0x10];                                    // 0x0108(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6LRR[0x20];                                    // 0x0160(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YQ3H[0x24];                                    // 0x0184(0x0024) MISSED OFFSET (PADDING)
...
struct FAnimNotifyEvent : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData_3CFP[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6LDH[0x2];                                     // 0x0092(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QKR7[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RU99[0x2];                                     // 0x00A2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                TrackIndex;                                                // 0x00A4(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_I35T[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
...
struct FQueuedDrawDebugItem
{
	...
	unsigned char                                      UnknownData_JZDX[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CQSP[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_9B70[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSlotEvaluationPose
{
	...
	unsigned char                                      UnknownData_V0I7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Weight;                                                    // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_336H[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
struct FSmartName
{
	...
	unsigned char                                      UnknownData_UZ4Z[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FRichCurveKey
{
	...
	unsigned char                                      UnknownData_VQ8C[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_P7JU[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimSegment
{
	...
	unsigned char                                      UnknownData_DC1L[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimBlueprintFunction
{
	...
	unsigned char                                      UnknownData_GCEK[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O8XV[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_M3YB[0xB0];                                    // 0x0000(0x00B0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7O08[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B1BH[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FNamedTransform
{
	...
	struct FName                                       Name;                                                      // 0x0030(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_6QE5[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FWeightedBlendable
{
	...
	unsigned char                                      UnknownData_IFJE[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDamageEvent
{
	unsigned char                                      UnknownData_8XQC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBasedMovementInfo
{
	...
	unsigned char                                      UnknownData_E5WG[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V0I2[0xE8];                                    // 0x0000(0x00E8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J7HD[0x2];                                     // 0x00EA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRepRootMotionMontage
{
	...
	unsigned char                                      UnknownData_V1YT[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7EHX[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ID4D[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	float                                              Time;                                                      // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_VX4J[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FUserActivity
{
	...
	unsigned char                                      UnknownData_ZI1W[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
