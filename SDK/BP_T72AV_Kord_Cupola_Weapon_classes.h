...
// BlueprintGeneratedClass BP_T72AV_Kord_Cupola_Weapon.BP_T72AV_Kord_Cupola_Weapon_C
// 0x0070 (FullSize[0x0A28] - InheritedSize[0x09B8])
class ABP_T72AV_Kord_Cupola_Weapon_C : public ASQVehicleWeapon
{
public:
	...
	unsigned char                                      UnknownData_BUN8[0x4];                                     // 0x09D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_T72AV_Kord_Cupola_Weapon.BP_T72AV_Kord_Cupola_Weapon_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_T72AV_Kord_Cupola_Weapon(int EntryPoint);
};
