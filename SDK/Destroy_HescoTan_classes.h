...
class ADestroy_HescoTan_C : public ASQLastingEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Destroy_HescoTan.Destroy_HescoTan_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Destroy_HescoTan(int EntryPoint);
};
