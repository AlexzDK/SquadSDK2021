...
// BlueprintGeneratedClass FOBRUS_Damage.FOBRUS_Damage_C
// 0x0028 (FullSize[0x02C8] - InheritedSize[0x02A0])
class AFOBRUS_Damage_C : public ASQLastingEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass FOBRUS_Damage.FOBRUS_Damage_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_FOBRUS_Damage(int EntryPoint);
};
