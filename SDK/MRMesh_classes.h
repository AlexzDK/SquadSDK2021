...
{
public:
	unsigned char                                      UnknownData_COAA[0x8];                                     // 0x0408(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_Q3Z2[0x5];                                     // 0x041B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2JPA[0x40];                                    // 0x0440(0x0040) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_543W[0x4];                                     // 0x022C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4M13[0x4];                                     // 0x0264(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G5UR[0x20];                                    // 0x0270(0x0020) MISSED OFFSET (PADDING)
