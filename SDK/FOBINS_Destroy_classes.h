...
class AFOBINS_Destroy_C : public ASQLastingEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass FOBINS_Destroy.FOBINS_Destroy_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_FOBINS_Destroy(int EntryPoint);
};
