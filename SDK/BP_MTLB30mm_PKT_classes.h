...
// BlueprintGeneratedClass BP_MTLB30mm_PKT.BP_MTLB30mm_PKT_C
// 0x0070 (FullSize[0x0A28] - InheritedSize[0x09B8])
class ABP_MTLB30mm_PKT_C : public ASQVehicleWeapon
{
public:
	...
	unsigned char                                      UnknownData_JO1V[0x4];                                     // 0x09D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MTLB30mm_PKT.BP_MTLB30mm_PKT_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MTLB30mm_PKT(int EntryPoint);
};
