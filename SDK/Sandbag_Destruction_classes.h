...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Sandbag_Destruction.Sandbag_Destruction_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Sandbag_Destruction(int EntryPoint);
};
