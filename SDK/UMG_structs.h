...
struct FEventReply
{
	unsigned char                                      UnknownData_3BH2[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
...
struct FAnimationEventBinding
{
	...
	unsigned char                                      UnknownData_DKC4[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PSXA[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_8KKA[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_E756[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_TU2P[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FBlueprintWidgetAnimationDelegateBinding
{
	...
	unsigned char                                      UnknownData_9JBM[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_I9MI[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FUserWidgetPool
{
	...
	unsigned char                                      UnknownData_4207[0x60];                                    // 0x0020(0x0060) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_XZCB[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_CELF[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieScene2DTransformSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_80Z1[0x3];                                     // 0x04A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_BEK2[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
