...
struct FBlackboardKeySelector
{
	...
	unsigned char                                      UnknownData_63FK[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NSW0[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FEnvDirection
{
	...
	unsigned char                                      UnknownData_K5FG[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FEnvOverlapData
{
	...
	unsigned char                                      UnknownData_KOR7[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3YTM[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OJR4[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H9VS[0x14];                                    // 0x0018(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LWR4[0xC];                                     // 0x0034(0x000C) MISSED OFFSET (PADDING)
...
struct FEQSParametrizedQueryExecutionRequest
{
	...
	unsigned char                                      UnknownData_0K6D[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GNXP[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (PADDING)
...
struct FEnvQueryRequest
{
	...
	unsigned char                                      UnknownData_MIE4[0x50];                                    // 0x0018(0x0050) MISSED OFFSET (PADDING)
...
struct FEnvQueryInstanceCache
{
	...
	unsigned char                                      UnknownData_GLT0[0x170];                                   // 0x0008(0x0170) MISSED OFFSET (PADDING)
...
struct FBTDecoratorLogic
{
	...
	unsigned char                                      UnknownData_A29Q[0x1];                                     // 0x0001(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlackboardEntry
{
	...
	unsigned char                                      UnknownData_O35L[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FBehaviorTreeTemplateInfo
{
	...
	unsigned char                                      UnknownData_Y6AC[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FAIMoveRequest
{
	...
	unsigned char                                      UnknownData_7TZ3[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PDXH[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_Q9Z0[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_1GUG[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIPredictionEvent
{
	...
	unsigned char                                      UnknownData_API2[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WICQ[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CFDH[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FAIDamageEvent
{
	...
	unsigned char                                      UnknownData_6OWI[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAISenseAffiliationFilter
{
	...
	unsigned char                                      UnknownData_NTAE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FActorPerceptionBlueprintInfo
{
	...
	unsigned char                                      UnknownData_CJ1T[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FAIStimulus
{
	...
	unsigned char                                      UnknownData_YCVD[0xC];                                     // 0x002C(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      UnknownData_QF16 : 1;                                      // 0x0038(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_C4VP[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_80R9[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_4KK8[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FAIDataProviderIntValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_JZEA[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIDataProviderFloatValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_F4V1[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIDynamicParam
{
	...
	unsigned char                                      UnknownData_LFJP[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEnvTraceData
{
	...
	unsigned char                                      UnknownData_IHQD[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SUL9[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDataProviderBoolValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_PS1K[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FPawnActionEvent
{
	...
	unsigned char                                      UnknownData_1XW4[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FEnvNamedValue
{
	...
	unsigned char                                      UnknownData_6216[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Value;                                                     // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
