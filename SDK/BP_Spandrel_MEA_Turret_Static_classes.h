...
// BlueprintGeneratedClass BP_Spandrel_MEA_Turret_Static.BP_Spandrel_MEA_Turret_Static_C
// 0x0070 (FullSize[0x04A0] - InheritedSize[0x0430])
class ABP_Spandrel_MEA_Turret_Static_C : public ASQVehicleTurretClosedTop
{
public:
	...
	float                                              Timeline_0_lerp_09871EF54B648079134F89B19C159FB3;          // 0x0490(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Timeline_0__Direction_09871EF54B648079134F89B19C159FB3;    // 0x0494(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_A2JM[0x3];                                     // 0x0495(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Spandrel_MEA_Turret_Static.BP_Spandrel_MEA_Turret_Static_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Spandrel_MEA_Turret_Static(int EntryPoint);
};
