...
class AFOB_DamageIns_C : public ASQLastingEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass FOB_DamageIns.FOB_DamageIns_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_FOB_DamageIns(int EntryPoint);
};
