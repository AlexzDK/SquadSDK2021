...
struct FMovieSceneTemplateGenerationLedger
{
	...
	unsigned char                                      UnknownData_70DW[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_3515[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SN9X[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvaluationTemplate
{
	...
	unsigned char                                      UnknownData_25J6[0x50];                                    // 0x0050(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q7LS[0x4];                                     // 0x0184(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_1Z2V[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J2YE[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvaluationTrack
{
	...
	unsigned char                                      UnknownData_0F4R[0x5];                                     // 0x0013(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z4UN[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneEasingSettings
{
	...
	unsigned char                                      UnknownData_ODLW[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0XNS[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_FN0B[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FMovieSceneTrackEvalOptions
{
	...
	unsigned char                                      UnknownData_3MFX[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneTrackDisplayOptions
{
	...
	unsigned char                                      UnknownData_YU7C[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvalTemplate : public FMovieSceneEvalTemplateBase
{
	...
	unsigned char                                      UnknownData_HE3H[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6CTN[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneSpawnable
{
	...
	unsigned char                                      UnknownData_WZ0J[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6IXN[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N264[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y35D[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneSequenceReplProperties
{
	...
	unsigned char                                      UnknownData_1BKF[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSequencePlaybackSettings
{
	...
	unsigned char                                      UnknownData_39CB[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8OK6[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WPDF[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSectionEvaluationData
{
	...
	unsigned char                                      UnknownData_V3YS[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HH17[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5ZJ5[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneByteChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_IRNX[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MPMZ[0x60];                                    // 0x0038(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneBoolChannel : public FMovieSceneChannel
{
	...
	bool                                               bHasDefaultValue;                                          // 0x0019(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_BKPP[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<bool>                                       Values;                                                    // 0x0020(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_ZFZ1[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneObjectBindingID
{
	...
	unsigned char                                      UnknownData_P3LD[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneBindingOverrideData
{
	...
	unsigned char                                      UnknownData_YX6C[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneMarkedFrame
{
	...
	unsigned char                                      UnknownData_OL8A[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_TW89[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SN9J[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FMovieSceneObjectPathChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_3E7H[0x60];                                    // 0x0060(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WN3H[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8G6G[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneKeyTimeStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_56S4[0x1C];                                    // 0x000C(0x001C) MISSED OFFSET (PADDING)
...
struct FMovieSceneIntegerChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_4C3D[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        Values;                                                    // 0x0020(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_RLFI[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneSequenceHierarchyNode
{
	...
	unsigned char                                      UnknownData_3XM9[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_B24J[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieSceneSubSequenceData
{
	...
	unsigned char                                      UnknownData_ETIK[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneSequenceInstanceDataPtr          InstanceData;                                              // 0x0068(0x0018) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_3MQ3[0x8];                                     // 0x0080(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IQ4N[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneFloatChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_BY23[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FFrameNumber>                        Times;                                                     // 0x0010(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	...
	unsigned char                                      UnknownData_L2NM[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneTangentData
{
	...
	unsigned char                                      UnknownData_CVB5[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatValue
{
	...
	unsigned char                                      UnknownData_H1HN[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_UUJ0[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XBIL[0x298];                                   // 0x0068(0x0298) MISSED OFFSET (PADDING)
...
struct FMovieSceneSubSectionData
{
	...
	unsigned char                                      UnknownData_N6ON[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_D0NG[0x58];                                    // 0x0000(0x0058) MISSED OFFSET (PADDING)
