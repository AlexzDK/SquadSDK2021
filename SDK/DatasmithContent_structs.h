...
struct FDatasmithCameraLookatTrackingSettingsTemplate
{
	...
	unsigned char                                      UnknownData_VI09[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithTessellationOptions
{
	...
	unsigned char                                      UnknownData_NPYY[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FDatasmithCameraFocusSettingsTemplate
{
	...
	unsigned char                                      UnknownData_5W7E[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithPostProcessSettingsTemplate
{
	...
	unsigned char                                      UnknownData_1RIG[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DZC8[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_196E[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithImportBaseOptions
{
	...
	unsigned char                                      UnknownData_UOQR[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithMeshBuildSettingsTemplate
{
	...
	unsigned char                                      UnknownData_Q9K6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
