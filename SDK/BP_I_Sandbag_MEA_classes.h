...
// BlueprintGeneratedClass BP_I_Sandbag_MEA.BP_I_Sandbag_MEA_C
// 0x0030 (FullSize[0x0400] - InheritedSize[0x03D0])
class ABP_I_Sandbag_MEA_C : public ABP_Deployable_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_I_Sandbag_MEA.BP_I_Sandbag_MEA_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_I_Sandbag_MEA(int EntryPoint);
};
