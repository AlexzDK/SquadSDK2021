...
// BlueprintGeneratedClass T72_Ammocook.T72_Ammocook_C
// 0x0048 (FullSize[0x0368] - InheritedSize[0x0320])
class AT72_Ammocook_C : public ABP_GenericDestroyedVehicleWreck_C
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0320(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	class UStaticMeshComponent*                        hatch;                                                     // 0x0328(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass T72_Ammocook.T72_Ammocook_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_T72_Ammocook(int EntryPoint);
};
