...
// WidgetBlueprintGeneratedClass UMG_MortarControl_Podnos.UMG_MortarControl_Podnos_C
// 0x0028 (FullSize[0x0288] - InheritedSize[0x0260])
class UUMG_MortarControl_Podnos_C : public USQMortarViewWidget
{
public:
	...
	class UMortarReticle_Podnos_C*                     MortarReticle_Podnos_96;                                   // 0x0270(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UMG_MortarControl_Podnos.UMG_MortarControl_Podnos_C");
		return ptr;
	}
	...
	void BPInit();
	void ExecuteUbergraph_UMG_MortarControl_Podnos(int EntryPoint);
};
