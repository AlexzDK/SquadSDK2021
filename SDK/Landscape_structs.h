...
struct FLandscapeLayer
{
	...
	unsigned char                                      UnknownData_D87X[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CJH7[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_QDNO[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FWeightmapLayerAllocationInfo
{
	...
	unsigned char                                      UnknownData_AX2Y[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FLandscapeComponentMaterialOverride
{
	...
	unsigned char                                      UnknownData_ZSMX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FPerPlatformInt                             LODIndex;                                                  // 0x0000(0x0004) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_P4YZ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UMaterialInterface*                          Material;                                                  // 0x0008(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
	unsigned char                                      UnknownData_RQ1W[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FGrassVariety
{
	...
	unsigned char                                      UnknownData_P1TL[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9XEB[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NTC6[0x5];                                     // 0x0043(0x0005) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TV8X[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FLayerBlendInput
{
	...
	unsigned char                                      UnknownData_5M3U[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FExpressionInput                            LayerInput;                                                // 0x000C(0x000C) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_V46U[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FExpressionInput                            HeightInput;                                               // 0x0020(0x000C) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_2G8N[0x8];                                     // 0x002C(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGrassInput
{
	...
	unsigned char                                      UnknownData_WFSL[0xC];                                     // 0x001C(0x000C) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineSegmentConnection
{
	...
	unsigned char                                      UnknownData_AOW6[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineMeshEntry
{
	...
	unsigned char                                      UnknownData_B0EN[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3Y11[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H38I[0x1];                                     // 0x0037(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9PCP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_N1J3[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9URB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineConnection
{
	...
	unsigned char                                      UnknownData_81DO[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_N3AD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
