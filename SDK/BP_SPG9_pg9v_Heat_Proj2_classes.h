...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_SPG9_pg9v_Heat_Proj2.BP_SPG9_pg9v_Heat_Proj2_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_SPG9_pg9v_Heat_Proj2(int EntryPoint);
};
