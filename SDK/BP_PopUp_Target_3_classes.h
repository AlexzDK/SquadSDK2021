...
// BlueprintGeneratedClass BP_PopUp_Target_3.BP_PopUp_Target_2_C
// 0x0069 (FullSize[0x02B1] - InheritedSize[0x0248])
class ABP_PopUp_Target_2_C : public AActor
{
public:
	...
	unsigned char                                      UnknownData_0JKF[0x3];                                     // 0x0261(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5XU1[0x3];                                     // 0x0269(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y58U[0x3];                                     // 0x0285(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WT84[0x4];                                     // 0x02A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PopUp_Target_3.BP_PopUp_Target_2_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PopUp_Target_3(int EntryPoint);
};
