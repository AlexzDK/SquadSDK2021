...
struct FEngineServicePong
{
	...
	unsigned char                                      UnknownData_OUPJ[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X278[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QKCB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
