...
struct FCompositeFallbackFont
{
	...
	unsigned char                                      UnknownData_LCHE[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FInputEvent
{
	unsigned char                                      UnknownData_PRUX[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XACS[0x58];                                    // 0x0018(0x0058) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OOQ9[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSlateColor
{
	...
	unsigned char                                      UnknownData_S5XG[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
struct FSlateBrush
{
	unsigned char                                      UnknownData_HTJE[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YBJ4[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_16CN[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (PADDING)
...
struct FSlateSound
{
	...
	unsigned char                                      UnknownData_69R2[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FFontOutlineSettings
{
	...
	unsigned char                                      UnknownData_W3FD[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSlateFontInfo
{
	...
	unsigned char                                      UnknownData_NQG7[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4KZX[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PJKX[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FFontData
{
	...
	unsigned char                                      UnknownData_HGWM[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGeometry
{
	unsigned char                                      UnknownData_O5A8[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FSliderStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_Q60W[0x4];                                     // 0x033C(0x0004) MISSED OFFSET (PADDING)
...
struct FInlineTextImageStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_P3TT[0x6];                                     // 0x0092(0x0006) MISSED OFFSET (PADDING)
...
struct FExpandableAreaStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_R7QD[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (PADDING)
...
struct FSearchBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_RQO1[0x7];                                     // 0x0A79(0x0007) MISSED OFFSET (PADDING)
...
struct FDockTabStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_L8I1[0x4];                                     // 0x06D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_MMWE[0x30];                                    // 0x0018(0x0030) MISSED OFFSET (PADDING)
...
struct FFocusEvent
{
	unsigned char                                      UnknownData_7MJ8[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FCheckBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_441H[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_9GPX[0x20];                                    // 0x0018(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T76Z[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NUCV[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5UT8[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
