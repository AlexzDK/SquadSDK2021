...
class ABP_MTLB_PKT_C : public ASQVehicleWeapon
{
public:
	...
	unsigned char                                      UnknownData_JF7P[0x4];                                     // 0x09D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MTLB_PKT.BP_MTLB_PKT_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MTLB_PKT(int EntryPoint);
};
