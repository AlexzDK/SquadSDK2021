...
class UBP_MarkerWidget_Helipad_C : public USQMapIconWidget
{
public:
	...
	unsigned char                                      UnknownData_MK8Y[0x4];                                     // 0x026C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BP_MarkerWidget_Helipad.BP_MarkerWidget_Helipad_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MarkerWidget_Helipad(int EntryPoint);
};
