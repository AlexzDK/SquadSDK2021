...
struct FGeomComponentCacheParameters
{
	...
	unsigned char                                      UnknownData_O3SO[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZMNW[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_24OO[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J380[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8UHF[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QTCT[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3H3D[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FChaosBreakingEventRequestSettings
{
	...
	unsigned char                                      UnknownData_6314[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FChaosCollisionEventRequestSettings
{
	...
	unsigned char                                      UnknownData_5TXS[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FGeometryCollectionSizeSpecificData
{
	...
	unsigned char                                      UnknownData_Y6HL[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_WN8U[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FGeometryCollectionDebugDrawActorSelectedRigidBody
{
	...
	unsigned char                                      UnknownData_CO2P[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FChaosTrailingEventRequestSettings
{
	...
	unsigned char                                      UnknownData_Q690[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
