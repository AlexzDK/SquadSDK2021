...
// BlueprintGeneratedClass BP_Konkurs_Proj2.BP_Konkurs_Proj2_C
// 0x0038 (FullSize[0x0558] - InheritedSize[0x0520])
class ABP_Konkurs_Proj2_C : public ASQMortarProjectile
{
public:
	...
	float                                              Timeline_0_Sine_0B6FFF784CE640C9599730A5B46E65BB;          // 0x0530(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<ETimelineDirection>                    Timeline_0__Direction_0B6FFF784CE640C9599730A5B46E65BB;    // 0x0534(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_P44I[0x3];                                     // 0x0535(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Konkurs_Proj2.BP_Konkurs_Proj2_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Konkurs_Proj2(int EntryPoint);
};
