...
struct FARFilter
{
	...
	unsigned char                                      UnknownData_D1ZM[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RDWC[0x5];                                     // 0x00E3(0x0005) MISSED OFFSET (PADDING)
...
struct FAssetData
{
	...
	unsigned char                                      UnknownData_43D6[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
