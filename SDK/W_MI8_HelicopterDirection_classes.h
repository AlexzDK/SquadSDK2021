...
class UW_MI8_HelicopterDirection_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass W_MI8_HelicopterDirection.W_MI8_HelicopterDirection_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_W_MI8_HelicopterDirection(int EntryPoint);
};
