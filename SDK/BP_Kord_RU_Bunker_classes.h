...
// BlueprintGeneratedClass BP_Kord_RU_Bunker.BP_Kord_RU_Bunker_C
// 0x0060 (FullSize[0x0430] - InheritedSize[0x03D0])
class ABP_Kord_RU_Bunker_C : public ABP_Deployable_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Kord_RU_Bunker.BP_Kord_RU_Bunker_C");
		return ptr;
	}
