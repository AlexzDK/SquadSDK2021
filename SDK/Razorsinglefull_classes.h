...
class ARazorsinglefull_C : public ASQLastingEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Razorsinglefull.Razorsinglefull_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Razorsinglefull(int EntryPoint);
};
