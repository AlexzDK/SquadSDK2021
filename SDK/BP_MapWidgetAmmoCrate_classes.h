...
class UBP_MapWidgetAmmoCrate_C : public USQMapWidgetAmmoCrate
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BP_MapWidgetAmmoCrate.BP_MapWidgetAmmoCrate_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MapWidgetAmmoCrate(int EntryPoint);
};
