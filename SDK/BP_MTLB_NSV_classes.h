...
// 0x0074 (FullSize[0x0A2C] - InheritedSize[0x09B8])
class ABP_MTLB_NSV_C : public ASQVehicleWeapon
{
public:
	...
	unsigned char                                      UnknownData_AX8M[0x4];                                     // 0x09D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	float                                              DelayOnEnteringSeat;                                       // 0x0A28(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MTLB_NSV.BP_MTLB_NSV_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MTLB_NSV(int EntryPoint);
};
